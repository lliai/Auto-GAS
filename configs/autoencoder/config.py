...
from gaswot.tnb101.models.task_models.decoder import GenerativeDecoder
from gaswot.tnb101.models.task_models.discriminator import Discriminator
from gaswot.tnb101.models.task_models.encoder import FFEncoder
from gaswot.tnb101.models.task_models.gan import GAN
...
def get_cfg(encoder_str):
    ...
    cfg['data_split_dir'] = str(Path(cfg['root_dir']) / 'data/final5k')
    cfg['log_dir'] = str(
        Path(cfg['root_dir']) /
        'output/benchmark_results/benchmark_results_local' / cfg['task_name'] /
    ...
    cfg['model_type'] = GAN(cfg['encoder'], cfg['decoder'],
                            cfg['discriminator'])
    ...
    cfg['metric_content'] = [
        'train_g_loss', 'train_d_loss', 'train_l1_loss', 'train_ssim',
        'val_l1_loss', 'val_ssim', 'test_l1_loss', 'test_ssim', 'time_elapsed'
    ]
    cfg['plot_msg'] = ''
