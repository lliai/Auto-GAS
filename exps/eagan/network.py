    ...
    for iter_idx, (imgs, _) in enumerate(tqdm(train_loader)):
        ...
        if global_steps % args.n_critic == 0:
            ...
            gen_z = torch.cuda.FloatTensor(
                np.random.normal(0, 1, (args.gen_bs, args.latent_dim)))
        ...
        if gen_step and iter_idx % args.print_freq == 0:
            tqdm.write(
                ...
                (epoch, args.max_epoch_D, iter_idx % len(train_loader),
...
def validate(args, fixed_z, fid_stat, gen_net: nn.Module, writer_dict):
    ...
    import random
    fid_score = random.random()
    # calculate_fid_given_paths([fid_buffer_dir, fid_stat], inception_path=None)
