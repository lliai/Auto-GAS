...
class TransNASBenchAPI(object):
    ...
    def __init__(self, database_path, verbose=False):
        ...
        self.info_names = self.database[
            'info_names']  # ['inference_time', 'encoder_params', 'encoder_FLOPs' ... ]
    ...
    def get_epoch_status(self, arch, task, epoch, xseed=None):
        """ get the status of a single epoch of a single architecture on a single task"""
