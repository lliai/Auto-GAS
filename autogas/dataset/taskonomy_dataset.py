...
def get_all_templates(dataset_dir, filenames_path):
    ...
    for building in building_lists:
        all_template_paths += load_ops.read_json(
            os.path.join(dataset_dir, building))
...
def get_datasets(cfg):
    ...
    train_data = TaskonomyDataset(
        os.path.join(cfg['data_split_dir'], cfg['train_filenames']),
        cfg['dataset_dir'],
        cfg['task_name'],
        cfg['target_load_fn'],
    ...
    val_data = TaskonomyDataset(
        os.path.join(cfg['data_split_dir'], cfg['val_filenames']),
        cfg['dataset_dir'],
        cfg['task_name'],
        cfg['target_load_fn'],
        target_load_kwargs=cfg['target_load_kwargs'],
    ...
    test_data = TaskonomyDataset(
        os.path.join(cfg['data_split_dir'], cfg['test_filenames']),
        cfg['dataset_dir'],
        cfg['task_name'],
        cfg['target_load_fn'],
        target_load_kwargs=cfg['target_load_kwargs'],
