...
from gaswot.utils.hessian import (group_product, hessian,
...
def compute_hawqv1(net, inputs, targets, split_data=1, loss_fn=None):
...
def compute_hawqv2(net, inputs, targets, split_data=1, loss_fn=None):
