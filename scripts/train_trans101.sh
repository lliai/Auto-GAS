...
gpu_id="0"
encoder_str="64-23443-basic"
seed="666"
ddp="0"

function usage
{
    echo "train_trans101.sh -g or --gpu for gpu_id; -t or --task for task_name; --seed for seed;
...
if [ "$ddp" = "0" ]; then
    CUDA_VISIBLE_DEVICES=$gpu_id python3 $code_dir/exps/main.py $config_dir/$task_name/ \
